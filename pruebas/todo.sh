...
MURO=(stress extras nuevas borrar xss hostil diagnostico demo seguridad vencimiento movil contraste dispositivos legales tarjetas miniaturas interfaz recorrido invitaciones)
ROLLO=(rollo_navegador rollo_organizador rollo_hora rollo_vence rollo_cinta rollo_maestra rollo_alta rollo_hostil rollo_recorrido)

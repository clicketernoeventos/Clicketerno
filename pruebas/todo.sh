...
MURO=(stress extras nuevas borrar xss hostil diagnostico demo seguridad vencimiento recorrido invitaciones)
ROLLO=(rollo_navegador rollo_organizador rollo_hora rollo_vence rollo_hostil rollo_recorrido)

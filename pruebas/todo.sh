...
MURO=(stress extras nuevas borrar xss hostil diagnostico demo seguridad recorrido invitaciones)
ROLLO=(rollo_navegador rollo_organizador rollo_hora rollo_hostil rollo_recorrido)
